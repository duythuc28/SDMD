...
public class GeoLocation implements Parcelable{
     ...
     *
     * @param elevation The elevation to set in Meters. An IllegalArgumentException
     ...
     *
     * @param name      The location name for display use such as &quot;Lakewood,
     *                  NJ&quot;
     * @param latitude  the latitude in a double format such as 40.095965 for
     *                  Lakewood, NJ <br/>
     *                  <b>Note: </b> For latitudes south of the equator, a negative
     *                  value should be used.
     * @param longitude double the longitude in a double format such as -74.222130 for
     *                  Lakewood, NJ. <br/>
     ...
     *                  href="http://en.wikipedia.org/wiki/Prime_Meridian">Prime
     *                  Meridian </a> (Greenwich), a negative value should be used.
     * @param elevation the elevation above sea level in Meters. Elevation is not used
     ...
     *
     * @param latitude The degrees of latitude to set. The values should be between
     ...
     *
     * @param degrees   The degrees of latitude to set between -90 and 90. An
     *                  IllegalArgumentException will be thrown if the value exceeds
     *                  the limit. For example 40 would be used for Lakewood, NJ.
     * @param minutes   <a href=
     *                  "http://en.wikipedia.org/wiki/Minute_of_arc#Cartography"
     *                  >minutes of arc</a>
     * @param seconds   <a href=
     *                  "http://en.wikipedia.org/wiki/Minute_of_arc#Cartography"
     *                  >seconds of arc</a>
     * @param direction N for north and S for south. An IllegalArgumentException will
     ...
     *
     * @param longitude The degrees of longitude to set in a double format between
     ...
     *
     * @param degrees   The degrees of longitude to set between -180 and 180. An
     *                  IllegalArgumentException will be thrown if the value exceeds
     ...
     *                  "http://en.wikipedia.org/wiki/Minute_of_arc#Cartography"
     *                  >seconds of arc</a>
     * @param direction E for east of the Prime Meridian or W for west of it. An
     ...
     *
     * @param location the destination location
     * @param formula  This formula calculates initial bearing (
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.INITIAL_BEARING);
        dest.writeInt(this.FINAL_BEARING);
    }
    ...
    protected GeoLocation(Parcel in) {
        ...
        this.INITIAL_BEARING = in.readInt();
        this.FINAL_BEARING = in.readInt();
    }
